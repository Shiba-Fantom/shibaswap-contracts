...
/** 
 *  SourceUnit: g:\work\Shibaswap_Fork\github\shibaswap-contracts\farm\contracts\GBoneTimelock.sol
*/
...
contract GBoneTimelock {
    ...
    constructor (IERC20 _gbone, IERC20 _gboneLP, address _beneficary) {

        gbone = _gbone;
        gboneLP = _gboneLP;
        uint currentTime = block.timestamp;

        createLock(_gbone, _beneficary, currentTime + 30 days);
        createLock(_gbone, _beneficary, currentTime + 60 days);
        createLock(_gbone, _beneficary, currentTime + 90 days);
        createLock(_gboneLP, _beneficary, currentTime + 365 days);
    }
