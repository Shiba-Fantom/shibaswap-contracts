...
/** 
 *  SourceUnit: g:\work\Shibaswap_Fork\github\shibaswap-contracts\periphery\contracts\examples\ExampleSlidingWindowOracle.sol
*/
...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'58941f97d310583d065b71bcccf7dbed4759de8fa9e8b11f136e6611c16b5324' // init code hash
            ))));
    }
